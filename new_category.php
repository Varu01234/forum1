...
if(isset($_POST['name'], $_POST['description']) and $_POST['name']!='' )
{
	...
	mysql_query('insert into tags values("'.$tag_name.'","'.$tag_desc.'")');
...
<form action="new_category.php" method="post">
	<label for="name">Name</label><input type="text" name="name" id="name" value="<?php echo $_SESSION['username']; ?>" /><br />
	<label for="tag_name">Tag Name</label><input type="text" name="tag_name" id="tag_name" /><br />
	<label for="tag_desc">Tag Description</label><input type="text" name="tag_desc" id="tag_desc" /><br />
